...
DrawableNote::DrawableNote(const Note &note, const graphics::drawable::Sprite &head) : m_note(note), m_head(head) {
}
...
void DrawableNote::submit(graphics::renderer::Renderer &renderer) const {

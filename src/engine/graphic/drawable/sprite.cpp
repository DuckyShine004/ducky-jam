...
Sprite::Sprite(double x, double y, double width, double height, const UV &uv, const std::string &texture_path, const std::string &effect_name) : m_x(x), m_y(y), m_offset_x(0.0f), m_offset_y(0.0f), m_width(width), m_height(height), m_uv(uv), m_texture_path(texture_path) {
